        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ps.admin.hashing') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label>Text / String:</label>
                                <textarea class="form-control" rows="3" name="string"
                                    required>{{ request()->string }}</textarea>
                            </div>
                            <button type="submit" name="generate" class="btn btn-block btn-flat btn-primary"><i
                                    class="fas fa-retweet"></i> Generate Hash</button>
                        </form>
                        <br /><br />
                        ...
                        <div class="tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="md5" class="tab-pane active show">
                                    ...
                                    <input value="{{ request()->has('string') ? md5(request()->string) : '' }}"
                                        name="md5" class="form-control" disabled>
                                </div>
                                <div id="base64" class="tab-pane">
                                    Generated Base64 Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? base64_encode(request()->string) : '' }}"
                                        name="base64" class="form-control" disabled>
                                </div>
                                <div id="sha-1" class="tab-pane">
                                    Generated SHA-1 Hash:<br />
                                    <input value="{{ request()->has('string') ? hash('sha1', request()->string) : '' }}"
                                        name="sha-1" class="form-control" disabled>
                                </div>
                                <div id="sha-256" class="tab-pane">
                                    Generated SHA-256 Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? hash('sha256', request()->string) : '' }}"
                                        name="sha-256" class="form-control" disabled>
                                </div>
                                <div id="sha-512" class="tab-pane">
                                    Generated SHA-512 Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? hash('sha512', request()->string) : '' }}"
                                        name="sha-512" class="form-control" disabled>
                                </div>
                                <div id="whirlpool" class="tab-pane">
                                    Generated Whirlpool Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? hash('Whirlpool', request()->string) : '' }}"
                                        name="whirlpool" class="form-control" disabled>
                                </div>
                                <div id="crypt" class="tab-pane">
                                    Generated Crypt Hash:<br />
                                    <input value="{{ request()->has('string') ? @crypt(request()->string) : '' }}"
                                        name="crypt" class="form-control" disabled>
                                </div>
                                <div id="md2" class="tab-pane">
                                    Generated MD2 Hash:<br />
                                    <input value="{{ request()->has('string') ? hash('md2', request()->string) : '' }}"
                                        name="md2" class="form-control" disabled>
                                </div>
                                <div id="md4" class="tab-pane">
                                    Generated MD4 Hash:<br />
                                    <input value="{{ request()->has('string') ? hash('md4', request()->string) : '' }}"
                                        name="md4" class="form-control" disabled>
                                </div>
                                <div id="crc32" class="tab-pane">
                                    Generated CRC32 Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? hash('crc32', request()->string) : '' }}"
                                        name="crc32" class="form-control" disabled>
                                </div>
                                <div id="gost" class="tab-pane">
                                    Generated Gost Hash:<br />
                                    <input value="{{ request()->has('string') ? hash('gost', request()->string) : '' }}"
                                        name="gost" class="form-control" disabled>
                                </div>
                                <div id="snefru" class="tab-pane">
                                    Generated Gost Hash:<br />
                                    <input
                                        value="{{ request()->has('string') ? hash('snefru', request()->string) : '' }}"
                                        name="snefru" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        Producing hash values for accessing data or for security. A hash value (or simply hash), also
                        called a message digest, is a number generated from a string of text. The hash is substantially
                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <li>
                                It can be used to compare large amounts of data. You create the hashes for the data,
                                store the hashes and later if you want to compare the data, you just compare the hashes.
                            </li>
                            <li>
                                Hashes can be used to index data. They can be used in hash tables to point to the
                                correct row. If you want to quickly find a record, you calculate the hash of the data
                                and directly go to the record where the corresponding hash record is pointing to. (This
                                assumes that you have a sorted list of hashes that point to the actual records)
                            </li>
                            <li>
