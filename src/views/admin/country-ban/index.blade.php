...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-user"></i> Country Bans</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card card-dark">
                    ...
                    Ban Mode: 
                        <a href="{{ route('ps.admin.country-ban', ['type' => 'blacklist']) }}" class="btn btn-flat btn-lg btn-rounded {{ ($setting->countryban_blacklist == 1) ? 'btn-danger' : 'btn-default' }}">Blacklist</a>
                        <a href="{{ route('ps.admin.country-ban', ['type' => 'whitelist']) }}" class="btn btn-flat btn-lg btn-rounded {{ ($setting->countryban_blacklist == 0) ? 'btn-success' : 'btn-default' }}">Whitelist</a> 
                        @if ($setting->countryban_blacklist == "0")
                        ...
                        <table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $country->redirect == 1 ? 'Yes' : 'No' }}</td>
                                    <td>
                                        <a href="{{ route('ps.admin.country-ban.edit', $country->id) }}"
                                            class="btn btn-flat btn-primary"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="{{ route('ps.admin.country-ban.delete', $country->id) }}"
                                            class="btn btn-flat btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="col-md-3">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('ps.admin.country-ban.add') }}" method="post">
                            @csrf
                    ...
                    <div class="card-footer">
                        <button class="btn btn-flat btn-danger" type="submit">Add</button>
