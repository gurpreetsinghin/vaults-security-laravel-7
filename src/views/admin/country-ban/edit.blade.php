...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                <form class="form-horizontal" action="{{ route('ps.admin.country-ban.edit', $country->id) }}" method="post">
                    @csrf
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Edit - Country Ban #{{ $country->id }}</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="redirect" class="form-control" required>
                                    <option value="0" {{ $country->redirect == 0 ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ $country->redirect == 1 ? 'selected' : '' }}>Yes</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Redirect URL: </label>
                                <input name="url" class="form-control" type="url" value="{{ $country->url }}">
                            </div>
                        </div>
