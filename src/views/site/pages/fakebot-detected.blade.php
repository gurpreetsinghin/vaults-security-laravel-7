        ...
        <div class="jumbotron">
            <center>
                <div class="alert alert-danger" style="background-color: #d9534f; color: white;">
                    <h5 class="alert-heading">You were identified as a Fake Bot and you cannot continue to the website
                    </h5>
                </div><br />
                ...
                <br />
                <a href="mailto:<?php echo $setting->email; ?>" class="btn btn-primary btn-block" target="_blank"><i
